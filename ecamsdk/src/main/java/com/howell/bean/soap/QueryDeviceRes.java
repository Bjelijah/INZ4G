...
public class QueryDeviceRes {
    ...
    public String toString() {
        return "QueryDeviceRes{" +
                "result='" + result + '\'' +
                ", nodeLists=" + (nodeLists==null?"":nodeLists.toString()) +
                ", wirelessNetwork=" + (wirelessNetwork==null?"":wirelessNetwork.toString()) +
                '}';
    }
    ...
    public static class NodeList{
        ...
        public NodeList(String devID, int channelID, String name, Boolean onLIne, Boolean ptzFlag, int securityArea, Boolean eStoreFlag, String upnpIP, int upnpPort, String devVer, int curVideoNum, String lastUpdated, int smsSubscribedFlag, int eMailSubscribedFlag, int sharingFlag, int applePushSubscribedFlag, int androidPushSubscribedFlag, int infraredFlag, int wirelessFlag) {
        ...
        public NodeList(String devID, int channelID, String name, Boolean onLIne, Boolean ptzFlag, int securityArea, Boolean eStoreFlag, String upnpIP, int upnpPort, String devVer, int curVideoNum, String lastUpdated, int smsSubscribedFlag, int eMailSubscribedFlag, int sharingFlag, int applePushSubscribedFlag, int androidPushSubscribedFlag, int infraredFlag, int wirelessFlag, String wirelessType, String SSID, int intensity) {
            this.devID = devID;
            this.channelID = channelID;
            this.name = name;
            this.onLIne = onLIne;
