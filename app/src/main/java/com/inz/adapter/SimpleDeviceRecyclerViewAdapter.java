...
public class SimpleDeviceRecyclerViewAdapter extends RecyclerView.Adapter<SimpleDeviceRecyclerViewAdapter.ViewHolder> implements IConfig {
    ...
    public SimpleDeviceRecyclerViewAdapter(){}


    public SimpleDeviceRecyclerViewAdapter(Context c,OnItemClickListener o){
        mContext = c;
...
//            holder.ivCamera.setBackgroundColor(mContext.getResources().getColor(R.color.item_camera_video));
    ...
    class ViewHolder extends RecyclerView.ViewHolder{
        View itemView;
        TextView tvName;
        ImageView ivCamera,ivWifi,ivInOffLine;
        LinearLayout llInfo;
        ...
        public ViewHolder(View itemView) {
            ...
            llInfo = (LinearLayout) itemView.findViewById(R.id.item_camera_info);
        }
    }
}
